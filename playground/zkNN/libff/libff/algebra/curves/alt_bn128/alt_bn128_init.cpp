...
void init_alt_bn128_params()
{
    ...
    alt_bn128_modulus_r = bigint_r("12464077797371606878856037333521951");
    assert(alt_bn128_Fr::modulus_is_valid());
    if (sizeof(mp_limb_t) == 8)
    {
        printf("a\n");
        alt_bn128_Fr::Rsquared = bigint_r("1114786216979099063361794822908073");
        alt_bn128_Fr::Rcubed = bigint_r("873553444500533703917133979591392");
        alt_bn128_Fr::inv = 12793347671037499937;
    }
    alt_bn128_Fr::num_bits = 114;
    alt_bn128_Fr::euler = bigint_r("6232038898685803439428018666760975");
