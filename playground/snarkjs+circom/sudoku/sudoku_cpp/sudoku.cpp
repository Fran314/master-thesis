...
uint get_size_of_witness() {return 1297;}
...
{
Fr_sub(&expaux[2],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 1]); // line circom 8
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&expaux[2]); // line circom 8
{{
...
{
Fr_sub(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)],&circuitConstants[0]); // line circom 30
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)],&expaux[2]); // line circom 30
{{
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_pow(&expaux[2],&circuitConstants[4],&lvar[1]); // line circom 31
Fr_mul(&expaux[1],&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)]); // line circom 31
Fr_add(&expaux[0],&lvar[0],&expaux[1]); // line circom 31
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Bits4_2_create(mySignalStart+1,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "upperBound";
Bits4_2_create(mySignalStart+6,1+ctx_index+1,ctx,new_cmp_name,myId);
...
while(Fr_isTrue(&expaux[0])){
{
Fr_sub(&expaux[2],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 0)],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 81)]); // line circom 57
Fr_mul(&expaux[1],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 0)],&expaux[2]); // line circom 57
{{
